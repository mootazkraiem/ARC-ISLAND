...
function systemPrompt(mode: SystemMode, reminders: Reminder[]): string {
  ...
  if (mode === 'forge') {
    base.push(
      ...
      'Your job in this mode is: LISTEN, then UNDERSTAND, then ORGANIZE, then PROPOSE. Do not call add_reminder in this mode — proposing a week is done with propose_week and nothing else.',
